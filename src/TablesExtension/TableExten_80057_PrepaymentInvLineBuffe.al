/// <summary>
/// TableExtension NCT Prepayment Inv. Line Buffe (ID 80057) extends Record Prepayment Inv. Line Buffer.
/// </summary>
tableextension 80057 "NCT Prepayment Inv. Line Buffe" extends "Prepayment Inv. Line Buffer"
{
    fields
    {
