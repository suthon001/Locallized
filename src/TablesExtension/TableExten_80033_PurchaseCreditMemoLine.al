/// <summary>
/// TableExtension ExtenPurchaseCr.MemoLine (ID 80033) extends Record Purch. Cr. Memo Line.
/// </summary>
tableextension 80033 "ExtenPurchaseCr.MemoLine" extends "Purch. Cr. Memo Line"
{
    fields
    {
