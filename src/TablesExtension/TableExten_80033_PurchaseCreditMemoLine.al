/// <summary>
/// TableExtension NCT PurchaseCr.MemoLine (ID 80033) extends Record Purch. Cr. Memo Line.
/// </summary>
tableextension 80033 "NCT PurchaseCr.MemoLine" extends "Purch. Cr. Memo Line"
{
    fields
    {
