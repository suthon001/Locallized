/// <summary>
/// TableExtension NCT ExtenBank Account Ledger (ID 80038) extends Record Bank Account Ledger Entry.
/// </summary>
tableextension 80038 "NCT ExtenBank Account Ledger" extends "Bank Account Ledger Entry"
{
    fields
    {
