/// <summary>
/// TableExtension NCT ExtenSales Invoice Line (ID 80020) extends Record Sales Invoice Line.
/// </summary>
tableextension 80020 "NCT ExtenSales Invoice Line" extends "Sales Invoice Line"
{
    fields
    {
