/// <summary>
/// PageExtension NCT Business Manager Role (ID 80105) extends Record Business Manager Role Center.
/// </summary>
pageextension 80105 "NCT Business Manager Role" extends "Business Manager Role Center"
{
    actions
    {
        addfirst(sections)
