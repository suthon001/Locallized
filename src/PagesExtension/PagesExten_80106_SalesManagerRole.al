/// <summary>
/// PageExtension NCT Sales Manager Role (ID 80106) extends Record Sales Manager Role Center.
/// </summary>
pageextension 80106 "NCT Sales Manager Role" extends "Sales Manager Role Center"
{
    actions
    {
        addfirst(sections)
