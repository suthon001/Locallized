/// <summary>
/// PageExtension NCT Team Member Role (ID 80107) extends Record Team Member Role Center.
/// </summary>
pageextension 80107 "NCT Team Member Role" extends "Team Member Role Center"
{
    actions
    {
        addlast(Purchasing)
