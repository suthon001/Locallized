...
table 50009 "WHT Header"
{
    ...
    fields
    {
        ...
        field(15; "VAT Branch Code"; Code[5])
        {
            ...
            DataClassification = CustomerContent;
            TableRelation = IF ("WHT Source Type" = CONST(Vendor)) "Customer & Vendor Branch"."Branch Code" WHERE("Source Type" = FILTER(Vendor), "Source No." = FIELD("WHT Source No.")) ELSE
            IF ("WHT Source Type" = CONST(Customer)) "Customer & Vendor Branch"."Branch Code" WHERE("Source Type" = FILTER(Customer), "Source No." = FIELD("WHT Source No."));
