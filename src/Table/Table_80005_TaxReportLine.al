/// <summary>
/// Table NCT Tax Report Line (ID 80005).
/// </summary>
table 80005 "NCT Tax Report Line"
{
    ...
    procedure "OnBeforeInsertVatLine"(var TaxReportLine: Record "NCT Tax Report Line"; var VatTransaction: Record "NCT VAT Transections")
    begin
