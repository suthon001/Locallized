/// <summary>
/// Table NCT VAT Transections (ID 80011).
/// </summary>
table 80011 "NCT VAT Transections"
{
    ...
    fields
    {
        ...
        field(99993; "Ref. Tax Type"; Enum "NCT Tax Type")
        {
            Editable = false;
            DataClassification = SystemMetadata;
            Caption = 'Tax Type';
        ...
        field(99997; "Allow Generate to Purch. Vat"; Boolean)
        {
            ...
            FieldClass = FlowField;
            CalcFormula = lookup("VAT Posting Setup"."NCT Allow to Purch. Vat" where("VAT Bus. Posting Group" = field("VAT Bus. Posting Group"), "VAT Prod. Posting Group" = field("VAT Prod. Posting Group")));
            Editable = false;
        ...
        field(99998; "Allow Generate to Sale Vat"; Boolean)
        {
            ...
            FieldClass = FlowField;
            CalcFormula = lookup("VAT Posting Setup"."NCT Allow to Sales Vat" where("VAT Bus. Posting Group" = field("VAT Bus. Posting Group"), "VAT Prod. Posting Group" = field("VAT Prod. Posting Group")));
            Editable = false;
