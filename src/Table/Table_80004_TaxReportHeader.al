/// <summary>
/// Table NCT Tax Report Header (ID 80004).
/// </summary>
table 80004 "NCT Tax Report Header"
{
    ...
    fields
    {
        ...
        {
            CalcFormula = Sum("NCT Tax Report Line"."Base Amount" WHERE("Tax Type" = FIELD("Tax Type"),
        ...
        {
            CalcFormula = Sum("NCT Tax Report Line"."VAT Amount" WHERE("Tax Type" = FIELD("Tax Type"),
                                                                    "Document No." = FIELD("Document No.")));
            Editable = false;
            FieldClass = FlowField;
    ...
    /// </summary>
    /// <param name="OldVatHeader">Parameter of type Record "NCT Tax Report Header".</param>
    /// <returns>Return variable "Boolean".</returns>
    procedure AssistEdit(OldVatHeader: Record "NCT Tax Report Header"): Boolean
    var
        VatHeader: Record "NCT Tax Report Header";
