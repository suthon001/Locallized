/// <summary>
/// Page NCT Get Purchase Lines (ID 80022).
/// </summary>
page 80022 "NCT Get Purchase Lines"
{
    ...
    begin
        ...
        if PurchaseQuotesLine.FindSet() then
            repeat
                ...
                PurchaseOrderLine."NCT Ref. PQ No." := PurchaseQuotesLine."Document No.";
                PurchaseOrderLine."NCT Ref. PQ Line No." := PurchaseQuotesLine."Line No.";
                PurchaseOrderLine."NCT Make Order By" := COPYSTR(UserId, 1, 50);
                PurchaseOrderLine."NCT Make Order DateTime" := CurrentDateTime;
