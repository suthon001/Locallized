/// <summary>
/// Report Report Sales Blanket (ID 80031).
/// </summary>
report 80031 "NCT Report Sales Blanket"
{
    Caption = 'Sales Blanket';
    DefaultLayout = RDLC;
    RDLCLayout = './LayoutReport/LCLReport/Report_80031_SalesBlanket.rdl';
