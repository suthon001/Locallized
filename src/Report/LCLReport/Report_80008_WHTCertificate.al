/// <summary>
/// Report NCT WHT Certificate (ID 50008).
/// </summary>
report 80008 "NCT WHT Certificate"
{
    DefaultLayout = RDLC;
    ...
    dataset
    {
        dataitem("WHT Header"; "NCT WHT Header")
        {
        ...
        dataitem(Integer; integer)
        {
            ...
            begin
                ...
                generaledgersetup.TestField("NCT No. of Copy WHT Cert.");
                SetFilter(Number, '%1..%2', 1, generaledgersetup."NCT No. of Copy WHT Cert.");
            end;
            ...
            begin
                case Number of
                    1:
                        WHTHeaderText[1] := generaledgersetup."NCT WHT Certificate Caption 1";
                    2:
                        WHTHeaderText[1] := generaledgersetup."NCT WHT Certificate Caption 2";
                    3:
                        WHTHeaderText[1] := generaledgersetup."NCT WHT Certificate Caption 3";
                    4:
                        WHTHeaderText[1] := generaledgersetup."NCT WHT Certificate Caption 4";
                end;
            end;
        }
    ...
    var
        WHTSetup: Record "NCT WHT Posting Setup";
        ...
        LocalFunction: Codeunit "NCT Function Center";
        PVNo: Code[30];
