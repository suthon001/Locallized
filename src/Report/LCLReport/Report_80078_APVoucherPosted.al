/// <summary>
/// Report NCT AP Voucher (ID 80078).
/// </summary>
report 80078 "NCT AP Voucher (Post)"
{
    Permissions = TableData "G/L Entry" = rimd;
    Caption = 'AP Voucher';
    DefaultLayout = RDLC;
    RDLCLayout = './LayoutReport/LCLReport/Report_80078_APVoucherPosted.rdl';
    ...
    dataset
    {
        ...
        {
            DataItemTableView = sorting("Document No.", "Line No.") where("NCT Tax Invoice No." = filter(<> ''));
        ...
        dataitem(WHTLINE; "Purch. Inv. Line")
        {
            ...
            DataItemTableView = SORTING("Document No.", "Line No.") where("NCT WHT Product Posting Group" = filter(<> ''));
