/// <summary>
/// Report WHT Certificate Preprint (ID 80009).
/// </summary>
report 80009 "NCT WHT Certificate Preprint"
{
    DefaultLayout = RDLC;
    RDLCLayout = './LayoutReport/LCLReport/Report_80009_WHTCertificatePreprint.rdl';
