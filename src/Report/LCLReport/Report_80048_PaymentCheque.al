/// <summary>
/// Report Payment Cheque (ID 80048).
/// </summary>
report 80048 "NCT Payment Cheque"
{
    Caption = 'Payment Cheque';
    DefaultLayout = RDLC;
    RDLCLayout = './LayoutReport/LCLReport/Report_80048_PaymentCheque.rdl';
    ...
    dataset
    {
        dataitem("Gen. Journal Line"; "Gen. Journal Line")
        {
            ...
            column(CQChequeNo_GenJournalLine; "Gen. Journal Line"."NCT Cheque No.")
            {
            }
            ...
            begin
                ...
                GenJnlLineDesc.SETFILTER("NCT Cheque Date", '<>%1', 0D);
                IF NOT GenJnlLineDesc.FIND('-') THEN
                    ERROR('Check Date in Document %1 cannot be blank.', "Document No.")
                ELSE BEGIN
                    var_DateInCheque := GenJnlLineDesc."NCT Cheque Date";

                    GetDateInCheque(GenJnlLineDesc."NCT Cheque Date");
                ...
                GenJnlLineVen.SETFILTER("NCT Require Screen Detail", '%1', "NCT Require Screen Detail"::CHEQUE);
                IF GenJnlLineVen.FIND('-') THEN
                    Payto := GenJnlLineVen."NCT Pay Name"
                ELSE BEGIN
                    GenJnlLineVen.RESET();
                    GenJnlLineVen.SETFILTER("Journal Template Name", '%1', "Journal Template Name");
                    GenJnlLineVen.SETFILTER("Journal Batch Name", '%1', "Journal Batch Name");
    ...
    var
        ...
        ChequeFormatOfBank: Enum "NCT Bank Cheque";
