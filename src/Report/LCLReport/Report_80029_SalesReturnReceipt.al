/// <summary>
/// Report Sales Return Receipt (ID 80029).
/// </summary>
report 80029 "NCT Sales Return Receipt"
{
    DefaultLayout = RDLC;
    RDLCLayout = './LayoutReport/LCLReport/Report_80029_SalesReturnReceipt.rdl';
    ...
    dataset
    {
        dataitem(SalesHeader; "Return Receipt Header")
        {
            ...
            dataitem(SalesLine; "Return Receipt Line")
            {
