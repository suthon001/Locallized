/// <summary>
/// Report Report Stock Card Cost (ID 80018).
/// </summary>
report 80018 "NCT Report Stock Card Cost"
{
    Permissions = TableData "Item Ledger Entry" = rimd;
    DefaultLayout = RDLC;
    RDLCLayout = './LayoutReport/LCLReport/Report_80018_StockCardCost.rdl';
        ...
        dataitem(Item; item)
        {
            ...
            dataitem("Item Ledger Entry"; "Item Ledger Entry")
            {
                ...
                begin
                    ...
                    var_AmountNeg := 0;
                    var_UnitCostNeg := 0;
                    CalcFields("NCT Document Invoice No.");

                    IF "Item Ledger Entry".Quantity > 0 THEN BEGIN
                        var_Pos := "Item Ledger Entry".Quantity;
                        "Item Ledger Entry".CALCFIELDS("Cost Amount (Actual)", "NCT Cost Amount (Actual Cal.)");
                        var_AmountPos := "Item Ledger Entry"."NCT Cost Amount (Actual Cal.)";
                        IF var_Pos <> 0 THEN
                    ...
                    ELSE BEGIN
                        ...
                        "Item Ledger Entry".CALCFIELDS("Cost Amount (Actual)", "NCT Cost Amount (Actual Cal.)");
                        var_AmountNeg := "Item Ledger Entry"."NCT Cost Amount (Actual Cal.)";
                        IF var_Neg <> 0 THEN
                    ...
                    "Item Ledger Entry".CALCFIELDS("Cost Amount (Actual)", "NCT Cost Amount (Actual Cal.)");
                    var_Amount := var_Amount + "Item Ledger Entry"."NCT Cost Amount (Actual Cal.)";
