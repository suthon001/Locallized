report 50007 "Posted Voucher"
{
    ...
    dataset
    {
        dataitem(GLEntry; "G/L Entry")
        {
            ...
            RequestFilterFields = "Posting Date", "Document No.", "Journal Batch Name";
    ...
    //     PreviewPost: Codeunit "Preview Posting";
    //     EntryNo: Integer;
    // begin
    //     TempAmt := 0;
    ...
    var
        GenJournalLine: Record "Posted Gen. Journal Line";
