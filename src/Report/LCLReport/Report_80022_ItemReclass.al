/// <summary>
/// Report ItemReclass (ID 80022).
/// </summary>
Report 80022 "NCT ItemReclass"
{
    RDLCLayout = './LayoutReport/LCLReport/Report_80022_ItemReclass.rdl';
    DefaultLayout = RDLC;
    ...
    dataset
    {
        dataitem("Item Journal Line"; "Item Journal Line")
        {
            ...
            column(Description; Description + ' ' + "NCT Description 2") { }
