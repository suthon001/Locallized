/// <summary>
/// Report Bank Acc. Reconciliation (ID 80046).
/// </summary>
report 80046 "Bank Acc. Reconciliation"
{
    DefaultLayout = RDLC;
    RDLCLayout = './LayoutReport/LCLReport/Report_80046_BankAccountReconciliation.rdl';
