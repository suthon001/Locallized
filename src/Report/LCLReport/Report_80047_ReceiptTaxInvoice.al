/// <summary>
/// Report Receipt Tax Invoice (ID 80047).
/// </summary>
report 80047 "NCT Receipt Tax Invoice"
{
    Caption = 'Receipt Tax Invoice';
    DefaultLayout = RDLC;
    RDLCLayout = './LayoutReport/LCLReport/Report_80047_ReceiptTaxInvoice.rdl';
    ...
    var
        ...
        CUFunction: Codeunit "NCT Function Center";
