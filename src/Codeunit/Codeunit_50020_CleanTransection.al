codeunit 50020 "Record Deletion Mgt."
{
    //Std. Table
    ...
    var
        ...
        RecordDeltetionEntry: Record "Record Deletion Table";
    ...
    begin
        ...
        MyTable.add('VAT Transections');
        MyTable.add('Tax Report Header');
        MyTable.add('Tax Report Line');
        MyTable.add('Posted ItemJournal Lines');
        MyTable.add('WHT Header');
        MyTable.add('WHT Lines');
        MyTable.add('Billing & Receipt Header');
        MyTable.add('Billing & Receipt Line');
